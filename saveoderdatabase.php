...
<body>
 ...
 for($i=0;$i<$c;$i++)
 {
 	...
 	{ if($quantity1>0){
 		...
 		$_SESSION['cart'][$curt]=array('item'=>$item[$i],
 ...
 if($food[$i]==2)
   ...
   echo" you have selected Rice ".$quantity2."plate<br>";
 	}
 }
 ...
 if($food[$i]==3)
   ...
   echo" you have selected CKICKEN CURRY ".$quantity3."plate<br>";
 	}
 }
 ...
 if($food[$i]==4)
 	{ if($quantity4>0){
 		...
 		$price=$price+(20*$quantity[$i]);
   echo" you have selected FISH CURRY".$quantity4."plate<br>";
 	}
 }
...
for($i=0;$i<$c;$i++)
 {
   ...
   echo" you have selected TEHARI ".$quantity5."plate<br>";}
 	}
   ...
   echo" you have selected khichuri ".$quantity6."plate<br>";
 	}
	 	}
   ...
   echo" you have selected Dal".$quantity7."plate<br>";
 	}
 }
 	...
 	{ if($quantity8>0){
 		...
 		$price=$price+(30*$quantity[$i]);
   echo" you have selected Beef curry ".$quantity8."plate<br>";
 	}
 }
